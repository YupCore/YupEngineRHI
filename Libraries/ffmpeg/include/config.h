...
#define FFMPEG_CONFIGURATION "--target-os=win64 --arch=x86_64 --toolchain=msvc --disable-everything --enable-decoder=h264 --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder=aac --enable-decoder=opus --enable-decoder=vorbis --enable-demuxer=mov --enable-demuxer=matroska --enable-protocol=file --enable-protocol=data --enable-protocol=async --enable-protocol=pipe --enable-static --disable-shared"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2024
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Оптимизирующий компилятор Microsoft (R) C/C++ версии 19.42.34435 для x64"
